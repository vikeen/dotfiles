...
" Modified by Ethan Herbertson, 2011
...
let colors_name="desert256-ethan"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    hi Normal       ctermfg=251 ctermbg=000 guibg=#000000   cterm=none      term=none       gui=none
    hi TabLine      ctermfg=15  ctermbg=242                 cterm=underline term=underline
    hi TabLineSel   ctermfg=251 ctermbg=000                 cterm=bold      term=bold
    hi TabLineFill  ctermfg=15  ctermbg=242                 cterm=reverse   term=reverse
    ...
    call <SID>X("Folded", "dddddd", "222222", "")
    call <SID>X("FoldColumn", "66ff88", "222222", "")
    ...
    call <SID>X("Search", "000000", "ffffff", "")
    ...
    call <SID>X("WildMenu", "dddddd", "222222", "")
    "Menu
    "Scrollbar
    "Tooltip
